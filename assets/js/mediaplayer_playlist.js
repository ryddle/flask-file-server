...
export class Playlist extends PlaylistEventTarget {
    ...
    constructor(mediaElement, options = {}) {
        ...
        this.mediaElement_.onended = function() {
            if (playlist.repeat_==playlist.#repeat_states.all) {
                ...
                playlist.mediaElement_.load(playlist.items_[playlist.currentIndex_].sources[0]);
    ...
    setItems(items) {
        ...
        this.mediaElement_.load(playlistItems[this.currentIndex_].sources[0]);
    ...
    */
    ...
    loadPlaylistItem(index) {
        ...
        this.mediaElement_.load(this.items_[index].sources[0]);
