...
;if(e.children.length>0&&(p.ignoreUnescapedHTML||(console.log("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),
console.log("https://github.com/highlightjs/highlight.js/wiki/security"),
console.log("The element with unescaped HTML:"),
console.log(e)),p.throwUnescapedHTML))throw new V("One of your code blocks includes unescaped HTML.",e.innerHTML)
